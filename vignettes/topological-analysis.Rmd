...
## Analyzing the robustnes of a host-parasite network
...
```{r save_topo, echo=FALSE}

# ggsave(filename = "robust_topology_heatmap.png",
#        path = "~/Documents/robustness/robustness/image/",
#        height = 6, width = 9)
...
<!-- # ggsave(filename = "robust_topology_heatmap_pres.png", -->

<!-- #  path = "~/Dropbox/seminaire/210402_ecostats/", height = 6, width = 9) -->
